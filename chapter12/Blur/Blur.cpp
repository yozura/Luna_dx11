...
void Blur::UpdateScene(float dt)
{
...
void Blur::OnMouseDown(WPARAM btnState, int x, int y)
{
    mLastMousePos.x = x;
    mLastMousePos.y = y;
...
void Blur::OnMouseUp(WPARAM btnState, int x, int y)
{
    ReleaseCapture();
}

void Blur::OnMouseMove(WPARAM btnState, int x, int y)
{
...
float Blur::GetHillHeight(float x, float z) const
{
    return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 Blur::GetHillNormal(float x, float z) const
{
    // n = (-df/dx, 1, -df/dz)
    XMFLOAT3 n(
...
void Blur::BuildLandGeometryBuffers()
{
...
void Blur::BuildWaveGeometryBuffers()
{
    D3D11_BUFFER_DESC vbd;
...
void Blur::BuildCrateGeometryBuffers()
{
...
void Blur::BuildScreenQuadGeometryBuffers()
{
